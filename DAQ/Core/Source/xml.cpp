	...
	u_int32_t& NoE, int& EventsPerFile, char *path, int& WriteToFile)
{
  ...
  if (xstr) {
	strcpy(txt,xstr); 
    col((char*)"gray"); printf("  DAQ Version: %s\n",txt); col((char*)"blue"); 
  ...
  if (xstr) {
    ...
    col((char*)"gray"); printf("  Channels:    %s\n",txt); col((char*)"blue");	
  ...
  if (xstr) {
    ...
    col((char*)"gray"); printf("  Channel 0:     %s\n",txt); col((char*)"blue");	
  ...
  if (xstr) {
    ...
    col((char*)"gray"); printf("  Channel 1:     %s\n",txt); col((char*)"blue");	
  ...
  if (xstr) {
    ...
    col((char*)"gray"); printf("  Channel 2:     %s\n",txt); col((char*)"blue");	
  ...
  if (xstr) {
    ...
    col((char*)"gray"); printf("  Channel 3:     %s\n",txt); col((char*)"blue");	
  ...
  if (xstr) {
    ...
    col((char*)"gray"); printf("  Channel 4:     %s\n",txt); col((char*)"blue");	
  ...
  if (xstr) {
    ...
    col((char*)"gray"); printf("  Channel 5:     %s\n",txt); col((char*)"blue");	
  ...
  if (xstr) {
    ...
    col((char*)"gray"); printf("  Channel 6:     %s\n",txt); col((char*)"blue");	
  ...
  if (xstr) {
    ...
    col((char*)"gray"); printf("  Channel 7:     %s\n",txt); col((char*)"blue");	
  ...
  if (xstr) {
    ...
    col((char*)"gray"); printf("  Frequency:   %s Hz\n",txt); col((char*)"blue");
  ...
  if (xstr) {
    ...
    col((char*)"gray"); printf("  Sample Size: %s bit\n",txt); col((char*)"blue");
  ...
  if (xstr) {
    ...
    col((char*)"gray"); printf("  Volt. Range: %s V\n",txt); col((char*)"blue");
  } else xml_error((char*)"sampling_freq");
