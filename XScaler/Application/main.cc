...
int main(int argc, char *argv[])
{
   ...
   strftime(filestring,100,"/home/sandbox/DAQ/XScaler/data/scaler_%y%m%d_%H%M.dat",timeinfo);

   double m_rates[16];
   TFile* output = new TFile("/home/sandbox/DAQ/XScaler/data/Test.root", "RECREATE");
...
// Start data stream
   while(c!='q')  {
	...
	fScaler.Test();
      ...
      cout<<fScaler.GetTimeString()<< endl << " "<<screenstream.str() << endl;
