#ifndef _MULTIADCMANAGER_H_
#define _MULTIADCMANAGER_H_
...
class MultiADCManager: public Common
{
 public:
   MultiADCManager();
   virtual ~MultiADCManager();
 ...
 private:
	...
	int m_pmtNb,m_BoardInfo,m_baseline,m_errflag,m_graphics,m_module; //I/O Parameters
